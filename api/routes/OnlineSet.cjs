...
*   get:
*     tags: [Online Set]
*     summary: Retrieve num of online sets
*     responses:
*       200:
*         description: Num of online sets
*         content:
*            application/json:
*              schema:
*               type: object
...
*                   type: array
*                   example: 
*                       [{"numTotal":62,"numTotalComplete":0}]
*       404:
...
router.get('/numSets', async function (req, res, next) {
    try {
        ...
        var message     = await onlineSetObject.getTotalNumSets();
...
*   get:
*     tags: [Online Set]
*     summary: Retrieve a list of online sets
*     parameters:
*       - in: query
*         name: page
*         schema:
...
*     responses:
*       200:
*         description: List of online sets
*         content:
*            application/json:
*              schema:
*                type: object
...
router.get('/', async function (req, res, next) {
    try {
        onlineSetObject = new OnlineSet();
        var message     = await onlineSetObject.getMultipleSets(req.query.filter, req.query.page);
